import { Appearance, CreateOrganizationTheme, OrganizationProfileTheme, OrganizationSwitcherTheme, SignInTheme, SignUpTheme, UserButtonTheme, UserProfileTheme } from './appearance';
...
export declare type DevSessionSyncMode = 'cookie' | 'cookieless';
